package cn.enilu.flash.mobile.wx.fastweixin.api.config;
...
import cn.enilu.flash.mobile.wx.fastweixin.api.response.GetJsApiTicketResponse;
import cn.enilu.flash.mobile.wx.fastweixin.api.response.GetTokenResponse;
import cn.enilu.flash.mobile.wx.fastweixin.exception.WeixinException;
import cn.enilu.flash.mobile.wx.fastweixin.handle.ApiConfigChangeHandle;
import cn.enilu.flash.mobile.wx.fastweixin.util.JSONUtil;
import cn.enilu.flash.mobile.wx.fastweixin.util.NetWorkCenter;
...
public final class ApiConfig extends Observable implements Serializable {
     ...
     */
    public ApiConfig(String appid, String secret,String token,boolean encryptMessage,String encodingAESKey) {
        this(appid, secret, token,encryptMessage,encodingAESKey,false);
    }
     ...
     */
    public ApiConfig(String appid, String secret,String token, boolean encryptMessage,String encodingAESKey,boolean enableJsApi) {
        this.appid = appid;
        this.secret = secret;
