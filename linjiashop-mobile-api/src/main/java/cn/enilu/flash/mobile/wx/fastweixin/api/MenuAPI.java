...
import cn.enilu.flash.mobile.wx.fastweixin.api.response.GetMenuResponse;
...
public class MenuAPI extends BaseAPI {
    ...
    public ResultType createMenu(Menu menu) {
        ...
        LOG.debug("创建菜单.....");
        String url = BASE_API_URL + "cgi-bin/menu/create?access_token="+config.getAccessToken();
        String menuJson = menu.toJsonString();
